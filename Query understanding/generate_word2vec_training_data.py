    ...
    with open(input_file, "r") as lines:
        for line in lines:
            ...
            if  "title" in entry and "category" in entry and "query" in entry:
                    ...
                    #prenatal dha nordic naturals prenatal dha 180ct prenatal dha
                    ...
                    #home theater system yamaha ns sp1800bl channel home theater speaker set home theater system electronics yamaha ns sp1800bl channel home theater speaker set electronics
                    if categoryStr != "":
                        word2vec_training.write(" ")
