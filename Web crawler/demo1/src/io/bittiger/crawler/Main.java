...
public class Main {
    ...
    private static void syncCrawl(String requestUrl) throws IOException{
        ...
        //******DOM*******
        Element idEle = doc.getElementById("result_0");
        System.out.println("1st prod asin :" + idEle.attr("data-asin"));
        Elements titleEles = idEle.getElementsByAttribute("title");
        System.out.println("1st prod title count " + titleEles.size());
        System.out.println("1st prod title  " + titleEles.get(0).attr("title"));
        ...
        for(int i = 0;i < prods.size();i++) {
            System.out.println("get prod title from attribute= " + prods.get(i).attr("title"));
        }
        Elements liTags = doc.getElementsByTag("li");
        for(int i = 0;i < liTags.size();i++) {
            String idStr = liTags.get(i).attr("id");
            if(idStr.startsWith("result")) {
                System.out.println("li id: " + idStr);
            }
        }
        ...
        //"a-link-normal s-access-detail-page  s-color-twister-title-link a-text-normal"
        //a-text-normal ==> ohuhuec
        //s-color-twister-title-link ==> jiint
        //
        Elements prodAdsAsin = doc.getElementsByClass("s-result-item celwidget  AdHolder");
        System.out.println("num of prod ads: " + prodAdsAsin.size());
        for(int i = 0;i < prodAdsAsin.size();i++) {
            System.out.println("prod asin " + prodAdsAsin.get(i).attr("data-asin"));
        }
        ...
        //*****Selector******
        String pageTitlebySelector = htmlTitle(doc);
        System.out.println("html page title by selector= " + pageTitlebySelector);
        ...
        //#result_1 > div > div.a-row.a-spacing-none.s-color-subdued > div.a-row.a-spacing-micro > a
        //#result_2 > div > div.a-fixed-left-grid > div > div.a-fixed-left-grid-col.a-col-right > div.a-row.a-spacing-small > div:nth-child(1) > a
        //#result_3 > div > div > div > div.a-fixed-left-grid-col.a-col-right > div.a-row.a-spacing-small > div.a-row.a-spacing-none.scx-truncate-medium.sx-line-clamp-2 > a
        ...
        //#result_3 > div > div > div > div.a-fixed-left-grid-col.a-col-right > div.a-row.a-spacing-small > div:nth-child(1) > a
        urlElePaths.add("#result_7 > div > div > div > div.a-fixed-left-grid-col.a-col-right > div.a-row.a-spacing-small > div.a-row.a-spacing-none.scx-truncate-medium.sx-line-clamp-2 > a");
...
//#dealTitle
        ////*[@id="dealTitle"]
        //#result_1 > div > div > div > div.a-fixed-left-grid-col.a-col-right > div.a-row.a-spacing-small > div.a-row.a-spacing-none.scx-truncate-medium.sx-line-clamp-2 > a
        ...
        Elements imageEles = doc.getElementsByClass("s-access-image cfMarker");
        for(int i = 0;i < imageEles.size();i++) {
            String imgUrl = imageEles.get(i).attr("src");
            System.out.println("image url from DOM = " + imgUrl);
