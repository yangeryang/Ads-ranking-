...
#python generage_click_log.py ./data/deduped/ads999.txt ./data/log/user.txt   ./data/log/query_camp_ad_file.json  ./data/log/campaign_weight_file.json  ./data/log/ad_weight_file.json  ./data/log/campaignId_category_file.json ./data/log/campaignId_adId_file.json ./data/log/click_log.txt
