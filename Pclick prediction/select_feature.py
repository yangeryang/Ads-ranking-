...
##./bin/spark-submit --master local[8] --driver-memory 2G 
if __name__ == "__main__":
    ...
    device_id_click.saveAsTextFile(output_dir + "demo5_device_id_click")
    device_id_impression.saveAsTextFile(output_dir + "demo5_device_id_impression")

    device_ip_click.saveAsTextFile(output_dir + "demo5_device_ip_click")
    device_ip_impression.saveAsTextFile(output_dir + "demo5_device_ip_impression")

    ad_id_click.saveAsTextFile(output_dir + "demo5_ad_id_click")
    ad_id_impression.saveAsTextFile(output_dir + "demo5_ad_id_impression")

    query_campaign_id_click.saveAsTextFile(output_dir + "demo5_query_campaign_id_click")
    query_campaign_id_impression.saveAsTextFile(output_dir + "demo5_query_campaign_id_impression")

    query_ad_id_click.saveAsTextFile(output_dir + "demo5_query_ad_id_click")
    query_ad_id_impression.saveAsTextFile(output_dir +"demo5_query_ad_id_impression")
    sc.stop()
